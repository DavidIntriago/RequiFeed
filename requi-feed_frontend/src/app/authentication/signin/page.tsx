  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response.data) {
        ...
        const { usuario, token, external_id, rol } = response.data;
        ...
        const perfilResponse = await get_api(`cuenta/perfil/${external_id}`);
        if (perfilResponse.data && perfilResponse.data.usuario?.id) {
          console.log("Usuario recuperado:", perfilResponse.data.usuario.nombre);
          console.log("ID recuperado:", perfilResponse.data.usuario.id);
          save('usuario_id', perfilResponse.data.usuario.id);
          save('grupo_id', perfilResponse.data.usuario.grupo?.id);
