...
const restrictedRoutes: Record<Role, string[]> = {
  [Role.DOCENTE]: [ "/docente", "/docente/dashboard", "/docente/profile", "/docente/profile/edit/:id", "/docente/proyectos", "/docente/proyectos/edit/:id" , "/docente/periodoAcademico", "/docente/usuarios", "/docente/tasks","/docente/groups",
