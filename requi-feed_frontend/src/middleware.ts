...
const restrictedRoutes: Record<Role, string[]> = {
  [Role.DOCENTE]: [ "/docente", "/docente/dashboard", "/docente/profile", "/docente/profile/edit/:id", "/docente/projects", "/docente/projects/edit/:id" , "/docente/periodoAcademico", "/docente/usuarios", "/docente/tasks","/docente/groups"], // Rutas restringidas para ADMIN
